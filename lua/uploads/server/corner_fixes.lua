--- Original path: lua/mainf/server/sv_swep.lua

-- Allows the crowbar to be taken without IsCheater flag, a little bit better antispam
do
	local wl = {}
	...
	local punishments = {
		...
		{ time = 14400, inwords = "4 часа" } -- plus kick
	}
	...
	hook.Remove( "PlayerSpawnProp", "sdas" )
