...
urltex.Image = function(path)			
	if url_tex and path:find("http") then
		local mat = CreateMaterial("http_material_" .. util.CRC(path) .. "_" .. FrameNumber(), "UnlitGeneric", {})

		url_tex.GetMaterialFromURL(path, function(_mat)
